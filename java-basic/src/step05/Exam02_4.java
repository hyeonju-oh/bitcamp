...
public class Exam02_4 {
    public static void main(String[] args) {
        ...
        // enum으로 정의된 상수를 사용하려면 enum 타입의 변수를 선언해야 한다
        // final int처럼 직접 값을 지정하지 않아도 된다
        // 값을 직접 지정할 수도 있다.
        // enum을 사용하는 주된 이유는?
        // -> 100, 200, "admin" 과 값이 값을 직접 지정할 필요가 없다.
...
// if vs switch
// 복잡한 조건으로 프로그램 흐름을 제어해야 하는 상황이라면 if문을 사용
// int나 문자열 처럼 단순한 값으로 프로그램을 제어할 수 있다면 switch문을 사용