...
public class TeamUpdateController implements Controller {
    ...
    public void service(ServerRequest request, ServerResponse response) {
        ...
        updateTeam.setStartDate(new Date(System.currentTimeMillis()));
        updateTeam.setEndDate(new Date(System.currentTimeMillis()));
        Team team = teamDao.get(updateTeam.getName());
