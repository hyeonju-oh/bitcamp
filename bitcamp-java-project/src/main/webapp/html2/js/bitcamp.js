...
jQuery.post = function(url, p1, p2, p3) {
	...
	if (arguments.length == 2) {
		...
		if (typeof p2 == "function") {
			...
			settings.dataTyep = p2;
			if (typeof p1 == "function") settings.success = p1; // .post(url, function, datayType);
...
jQuery.get = function(url, p1, p2, p3) {
	...
	if (arguments.length == 2) {
		...
		if (typeof p2 == "function") {
			...
			settings.dataTyep = p2;
			if (typeof p1 == "function") settings.success = p1; // .get(url, function, datayType);
