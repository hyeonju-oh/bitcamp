...
// 필터
// - 서블릿을 실행하기 전이나 후에 특정 작업을 수행하고 싶을 때 사용하는 기술
// - 예:
//   => 클라이언트의 접속을 기록하는 기능
//   => 클라이언트가 보낸 데이터의 압축을 해제
//   => 클라이언트가 보낸 데이터의 암호를 해제
//   => 서블릿 작업을 수행하기 전에 공통으로 처리해야 하는 작업을 수행
//   => 클라이언트의 인증 또는 권한 검사
//   => 클라이언트에게 보낼 데이터를 암축하거나 암호화시키기
...
public class Filter1 implements Filter {
    ...
    @Override
    public void destroy() {
        // 웹 애플리케이션을 멈추거나 서블릿 컨테이너를 멈출 때 호출한다.
