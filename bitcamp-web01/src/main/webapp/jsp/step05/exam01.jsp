...
<pre>
- 변수, 조건문, 반복문, URL 다루기, 국제화 지원, 숫자 및 날짜 형식 변환, DB 연동 등
...
1) Core : 변수, 조건문, 반복문 등을 다루는 태그
   &lt@ tablib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
2) XML : XML을 다루는 태그
   &lt@ tablib uri="http://java.sun.com/jsp/jstl/xml" prefix="x"%>
3) I18N : 국제화 프로그래밍 지원하는 태그
   &lt@ tablib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
4) 데이터베이스 : DB와 연동하여 SQL을 실행하는 태그
   &lt@ tablib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>
5) Functions : 함수 호출을 다루는 태그
   &lt@ tablib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn"%>
</pre>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/xml" prefix="x"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="sql"%>
