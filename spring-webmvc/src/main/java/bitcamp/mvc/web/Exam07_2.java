// URL에서 값을 추출하기 - Matrix Variable(매트릭스 변수)
...
public class Exam07_2 {
    ...
    public String m2(
        ...
        // 주의!
        // => @MatirxVariable 애노테이션을 사용하려면 matrix variable 기능을 활성화 해야 한다.
        ...
        // 예) 클라이언트에서 URL을 다음과 같은 형식으로 데이터를 보낼 때,
        //        ../exam07_2/m2/name=aaa;age=20;tel=111-2222
        //     => value ="name=aaa;age=20;tel=111-2222"
        //     => name = "aaa"
        //     => age = 20
        //     => tel = "111-2222"
        
        // 예) 클라이언트에서 URL을 다음과 같은 형식으로 데이터를 보낼 때,
        //        ../exam07_2/m2/test;name=aaa;age=20;tel=111-2222
        //     => value ="test"
        //     => name = "aaa"
        //     => age = 20
        //     => tel = "111-2222"
