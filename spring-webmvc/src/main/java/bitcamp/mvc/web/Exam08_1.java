...
public class Exam08_1 {
    ...
    public String m1(String name, HttpSession session) {
        // 테스트:
        //      http://localhost:8888/spring-webmvc/mvc/exam08_1/m1?name=hong
        // 세션에 데이터 보관
    ...
    public String m2(int age, HttpSession session) {
        // 테스트:
        //      http://localhost:8888/spring-webmvc/mvc/exam08_1/m2?age=20
        // 세션에 데이터 보관
    ...
    public String m3(boolean working, HttpSession session) {
        // 테스트:
        //      http://localhost:8888/spring-webmvc/mvc/exam08_1/m3?working=true
        // 세션에 데이터 보관
