...
public class Exam08_3 {
    ...
    public String m1(String name, Model model) {
        // 테스트:
        //      http://localhost:8888/spring-webmvc/mvc/exam08_3/m1?name=hong
    ...
    public String m2(int age, Model model) {
        // 테스트:
        //      http://localhost:8888/spring-webmvc/mvc/exam08_3/m2?age=20
        // 세션에 데이터 보관
    ...
    public String m3(boolean working, Model model) {
        // 테스트:
        //      http://localhost:8888/spring-webmvc/mvc/exam08_3/m3?working=true
        // 세션에 데이터 보관
