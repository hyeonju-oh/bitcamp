...
//    - 사용자 인증 또는 권한 검사할 때
//    - 로그를 남길 때
//    - 페이지 컨트롤러를 실행하기 전에 클라이언트가 보낸 데이터를 암호 해제하거나
...
public class Exam09_1_interceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
            throws Exception {
        System.out.println("Exam09_1_interseptor.preHandle()");
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        System.out.println("Exam09_1_interseptor.postHandle()");
    }
    
    @Override
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
            throws Exception {
        System.out.println("Exam09_1_interseptor.afterCompletion()");
    }
}