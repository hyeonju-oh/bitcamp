...
public class Exam05_3 {
    ...
    // 프론트 컨트롤러로부터 클라이언트가 보낸 값들을 객체에 담아 받을 수 있다.
    // 테스트: http://localhost:8888/spring-webmvc/mvc/exam05_3/m2?no=11&title=222&content=bbb
    @GetMapping(value="m1")
    @ResponseBody
    ...
    // 테스트: http://localhost:8888/spring-webmvc/mvc/exam05_3/m2?no=11&title=222&content=bbb&writer=hong
    @GetMapping(value="m2")
    @ResponseBody
    ...
    // 테스트:
    // http://localhost:8888/spring-webmvc/mvc/exam05_3/m3?no=11&title=222&content=bbb&user.id=hong&user.email=test1@test.com&user.password=1111
    @GetMapping(value="m3")
    @ResponseBody
